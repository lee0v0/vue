<template>
  <div id="app">
    ...
    <!--            <el-menu-item-group>-->
    <!--              <template slot="title" index="1-1">页面1</template>-->
    <!--            </el-menu-item-group>-->
    <!--            <el-menu-item-group>-->
    <!--              <template slot="title" index="1-2">页面2</template>-->
    <!--            </el-menu-item-group>-->
    <!--          </el-submenu>-->
    <!--          <el-submenu index="2">-->
    <!--            <template slot="title"><i class="el-icon-message"></i>导航二</template>-->
    <!--            <el-menu-item-group>-->
    <!--              <template slot="title" index="2-1">页面3</template>-->
    <!--            </el-menu-item-group>-->
    <!--            <el-menu-item-group>-->
    <!--              <template slot="title" index="2-2">页面4</template>-->
    <!--            </el-menu-item-group>-->
    <!--          </el-submenu>-->
